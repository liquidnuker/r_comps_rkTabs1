...
var _AsyncTabItem = __webpack_require__(26);

var _AsyncTabItem2 = _interopRequireDefault(_AsyncTabItem);
...
function TabContent(props) {
  if (props.pr_currentItem === "tab1") {
    return React.createElement(TabItem1, null);
  }

  if (props.pr_currentItem === "tab2") {
    return React.createElement(_AsyncTabItem2.default, null);
  }
}
...
var _reactAsyncComponent = __webpack_require__(27);

exports.default = (0, _reactAsyncComponent.asyncComponent)({
  resolve: function resolve() {
    return __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 2));
  }
}); // wrapper
